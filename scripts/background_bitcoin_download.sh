...
mkdir -p ./tar ; tar -xf bitcoin-* -C ./tar/ || true
git clone https://github.com/bitcoin/bitcoin.git bitcoin_github || true
...
git clone https://github.com/bitcoinknots/bitcoin.git bitcoinknots_github || true
